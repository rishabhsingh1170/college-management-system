...
import resetPasswordImg from "../assets/reset-password-img.jpg"
import AOS from "aos";
...
const stylishBackground = resetPasswordImg;
      ...
      <div className="relative z-20 flex flex-col lg:flex-row w-full max-w-5xl h-full lg:h-[600px] rounded-3xl overflow-hidden shadow-2xl animate-fadeIn">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-6 max-w-sm">
            ...
            <div className="relative">
              <FaCheckCircle className="absolute top-1/2 left-4 -translate-y-1/2 text-gray-400" />
              <input
                type="password"
